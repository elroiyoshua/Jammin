...
public class ProfileCreator extends AppCompatActivity {
    ...
    private DatabaseReference root = FirebaseDatabase.getInstance().getReference().child("Creator").child(displayUsername).child("Profile_Image");
    private StorageReference reference = FirebaseStorage.getInstance().getReference().child("Creator").child(displayUsername).child("Profile_Image");
